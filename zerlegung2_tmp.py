...
def zerlegung(ausgabe_ordner = './daten_zerlegung', eingabe_ordner = '/home/herval/Documents/THB/Master/Semester1/Projekt1/DataMining/ProjektAufgabe/Eyetracking/2016 - Data Mining Projekt/1 - Aufgabe/DatenTHB', eingabe_prefix = 'vp_', eingabe_blick_suffix = '_gaze', ausgabe_prefix = 'vp_', ausgabe_blick_suffix = '_gaze', messung_ordner_prefix = 'messung', probe_ordner_prefix = 'probe', delim = ' '):
